...
POLICY_TO_ICD: dict[str, list[str]] = {
    ...
    # --- Expansion: 10 additional specialties (appended after the originals so the first
    # 75 generated cases above are reproduced byte-for-byte — random draws are consumed in
    # dict-iteration order, and Python dicts preserve insertion order). ---
    "POL-PULM-O2-033": ["J96.10"],
    "POL-PULM-CPAP-034": ["G47.30"],
    "POL-PULM-REHAB-035": ["J44.9"],
    "POL-PULM-BIO-ASTHMA-037": ["J45.50"],
    "POL-RHEUM-BIO-RA-038": ["M05.79"],
    "POL-RHEUM-BIO-PSA-039": ["L40.54"],
    "POL-RHEUM-BIO-AS-040": ["M45.9"],
    "POL-RHEUM-IVIG-LUPUS-041": ["M32.9"],
    "POL-ENDO-PUMP-044": ["E10.9"],
    "POL-ENDO-PARATHY-045": ["E21.0"],
    "POL-NEPH-DIALYSIS-047": ["N18.6"],
    "POL-NEPH-TRANSPLANT-048": ["N18.5"],
    "POL-NEPH-NEPHRECTOMY-049": ["C64.1"],
    "POL-DERM-BIO-PSO-051": ["L40.0"],
    "POL-DERM-MOHS-052": ["C44.91"],
    "POL-DERM-BIO-HS-053": ["L73.2"],
    "POL-DERM-PHOTO-054": ["L20.9"],
    "POL-URO-BPH-055": ["N40.1"],
    "POL-URO-PROSTHESIS-057": ["N48.4"],
    "POL-URO-SACRAL-058": ["N32.81"],
    "POL-PSYCH-TMS-059": ["F33.2"],
    "POL-PSYCH-ECT-060": ["F33.3"],
    "POL-PSYCH-INPT-061": ["F20.9"],
    "POL-ENT-COCHLEAR-063": ["H90.3"],
    "POL-ENT-TONSIL-064": ["J35.01"],
    "POL-OPHTH-ANTIVEGF-066": ["H35.30"],
    "POL-OPHTH-CATARACT-067": ["H25.9"],
    "POL-OPHTH-GLAUCOMA-068": ["H40.9"],
}
